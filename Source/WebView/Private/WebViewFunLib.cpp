...
bool UWebViewFunLib::SetCookie(const FString& URL, const FWebCookie& Cookie) {
	...
	return webview::UWebViewFunLib::SetCookie(URL, in);
#else
	return false;
#endif
}
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::DeleteCookies(URL, CookieName);
#else
	return false;
#endif
}
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::PopupURL(URL);
#else
	return ;
#endif
}
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::EncodeURL(URL, use_plus);
#else
	return FString();
#endif
}
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::Base64Encode(data);
#else
	return FString();
#endif
}
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::Base64Decode(base64);
#else
	return FString();
#endif
}
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::Base64EncodeFile(file);
#else
	return FString();
#endif
}
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::Base64DecodeFile(base64,file);
#else
	return false;
#endif
...
#ifdef WEBVIEW_CUSTOMIZED_CORE
	return webview::UWebViewFunLib::Zip(Dir, ZipFile, IncludeHiddenFiles);
#else
	return false;
#endif
}
...
FImitateInput& UWebViewFunLib::AddKeystroke(FImitateInput& screen, const WebView_ImitateInput_Key keyboard, const FKey& key, const TArray<FKey>& CombinKey) {
	...
	int modify = 0 ;
#ifdef WEBVIEW_CUSTOMIZED_CORE
	modify = webview::UWebViewFunLib::KeytoInner(CombinKey);
#endif
	FKey inK = key;
